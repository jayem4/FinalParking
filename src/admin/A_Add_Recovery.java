...
public class A_Add_Recovery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Main.add(confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 410, 90, 30));
        ...
        Main.add(sq, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 280, 410, 30));
        Main.add(ans, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 340, 410, 30));
        ...
        Main.add(logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 510, -1, 40));
        ...
        Main.add(acc_phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 430, 300, 30));
        ...
        Main.add(acc_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 390, 300, 30));
        ...
        Main.add(acc_uname, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 350, 300, 30));
        ...
        Main.add(acc_lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 310, 300, 30));
        ...
        Main.add(acc_fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 270, 300, 30));

        acc_id.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        acc_id.setForeground(new java.awt.Color(255, 255, 255));
        acc_id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        acc_id.setText("ID");
        Main.add(acc_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 200, 300, 30));
        ...
        Main.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 440, 40));
        ...
        Main.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 70, 220, 130));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/admin/qws.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        Main.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 550));

        getContentPane().add(Main, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 550));
